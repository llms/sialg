define([
  "cdf/lib/jquery",
    'pentaho/api/repos/pentaho-cdf/js/lib/CCC/protovis.js',
    'cdf/dashboard/Utils',
    'pentaho/api/repos/pentaho-cdf/js/lib/CCC/jquery.tipsy.js'
    ...
    function _configureLocale(dashboard){
      Utils.configLanguage('pt-br', {
                ...
                dateLocale: {
                    ...
                    weekdays : [
                      "Domingo", "Segunda", "TerÃƒÆ’Ã‚Â§a", "Quarta", "Quinta", "Sexta", "SÃƒÆ’Ã‚Â¡bado"
                    ],
                    weekdaysShort : [
                      "Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "SÃƒÆ’Ã‚Â¡b"
                    ],
